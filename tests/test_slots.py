...
from patroni.psycopg import OperationalError, UndefinedFile
...
class TestSlotsHandler(BaseTestPostgresql):
    ...
    def test_sync_replication_slots(self):
        ...
        with mock.patch('patroni.postgresql.Postgresql._query', Mock(side_effect=OperationalError)):
    ...
    def test__ensure_logical_slots_replica(self):
        ...
        with patch.object(MockCursor, 'execute', Mock(side_effect=UndefinedFile)):
    ...
    @patch.object(MockCursor, 'execute', Mock(side_effect=OperationalError))
